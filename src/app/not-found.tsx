    ...
    <main className="grid place-items-center h-screen bg-navy">
      <div className="max-w-xs h-96 grid grid-rows-2 grid-cols-3 pb-10">
        ...
        <div className="row-span-1 col-span-3 self-start text-center font-normal leading-6 text-slate-200 pt-5">
          <div className="pb-5">
            Sorry, we can&apos;t find that page. It may have been removed, is
            temporarily unavailable, or possibly never existed.
          </div>
          <Link href="/">
            <button className="bg-slate-400 hover:bg-slate-300 text-navy font-normal py-2 px-4 rounded-full border border-white">
              Return Home
            </button>
          </Link>
        </div>
