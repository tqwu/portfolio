...
const projects = [
  {
    ...
    description: [
      ...
      `(This project has been sponsored by UCSC for continued development and integration into official course planning use for students!)`,
    ],
  },
  {
      ...
      <div className="px-5 text-slate-200 font-mono grid pt-12 pb-16">
        ...
        <div className="grid place-self-center place-items-center sm:w-4/5">
          {projects.map((project) => (
            <div key={project.title} className="w-full 2xl:w-3/4">
              <motion.div
                whileHover={{
                  scale: [null, 1.05],
                  transition: {
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-1 border-2 rounded-xl border-slate-500 py-6 px-3 my-2 2xl:px-12">
