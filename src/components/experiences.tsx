      ...
      <div className="px-5 text-slate-200 font-mono grid pt-12 pb-16">
        ...
        <div className="grid place-self-center place-items-center md:w-2/3 2xl:w-3/4">
          {technical.map((experience) => (
            <div key={experience.header} className="w-full 2xl:w-2/3">
              <motion.div
                whileHover={{
                  scale: [null, 1.05],
                  transition: {
              ...
              >
                <div className="grid gap-1 grid-cols-3 w-full border-2 rounded-xl border-slate-500 py-6 px-3 my-2 2xl:px-16">
                  {/* Mobile view image */}
        ...
        <div className="grid place-self-center place-items-center md:w-2/3 2xl:w-3/4">
          {leadership.map((experience) => (
            <div key={experience.header} className="w-full 2xl:w-2/3">
              ...
              >
                <div className="grid gap-1 grid-cols-3 border-2 rounded-xl border-slate-500 py-6 px-3 my-2 2xl:px-16">
                  {/* Mobile view image */}
                  <div className="col-span-3 pb-4 w-2/3 grid justify-self-center place-items-center block lg:hidden">
                    <Image
                      className=""
